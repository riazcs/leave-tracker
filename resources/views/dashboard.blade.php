                    ...
                    <tbody>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditLeave{{ $leave->id }}">
                            <div class="offcanvas-header">
                                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Update Leave Form</h5>
                                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body mx-0 flex-grow-0">
                                <form class="add-new-user pt-0" id="updateUserForm" action="{{ route('leaves.update', $leave->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" rows="4" name="reason" class="form-control" placeholder="Reason" aria-label="reason">{{$leave->reason}}</textarea>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <select class="form-control form-select" name="type">
                                            ...
                                            <option value="{{ $key }}" @if($key==$leave->type) selected @endif>{{ $status }}</option>
                                            @endforeach
                                        </select>
