                ...
                <table class="datatables-users table border-top" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td><span class="user-email">{{$user->contact}}</span></td>
                            <td><span class="user-email">{{$user->package ? $user->package->name : ""}}</span></td>
                            <td><span class="user-email">{{$user->total_balance }}</span></td>
                            <td><span class="user-email">{{$user->email}}</span></td>
                            <td class="text-center">
                                @if($user->email_verified_at)
                                <i class="bx fs-4 bx-check-shield text-success"></i>
                                @else
                                <i class="bx fs-4 bx-shield text-danger"></i>
                                @endif
                            </td>
                            <td><button class="btn btn-sm btn-info edit-record" data-id="{{ $user->id }}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddBalance{{ $user->id }}">Add
                                    Balance</i></button>
                            </td>
                            <td>
                                <div class="row">
